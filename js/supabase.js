...
// Si el usuario marcó "Mantener sesión" → localStorage (persiste entre cierres de Chrome)
// Si no → sessionStorage (se borra al cerrar Chrome, sin necesidad de lógica extra)
const esPermanente = localStorage.getItem('sesion-permanente') === '1'

export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
  auth: {
    persistSession:   true,
    autoRefreshToken: true,
    storageKey:       'ubipet-auth',
    storage:          esPermanente ? localStorage : sessionStorage,
  }
})
